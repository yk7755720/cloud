...
public class PdfHelper {
    ...
    public static ITextRenderer getRender() throws DocumentException, IOException {
        ...
        String path = getPath();
        //添加字体，以支持中文
        /*render.getFontResolver().addFont( "D://arialuni.ttf", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
        render.getFontResolver().addFont( "D://simsun.ttc", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);*/
        render.getFontResolver().addFont("/usr/local/fmy-ym/arialuni.ttf", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
        render.getFontResolver().addFont("/usr/local/fmy-ym/simsun.ttc", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
